  ...
  [
    {
      ...
      Destination: -1,
      Options: [
        { OptionIndex: 0.0, Text: "Go Left", Destination: 19, AffectionChange: 0 },
        { OptionIndex: 1.0, Text: "Go Right", Destination: 1, AffectionChange: 0 },
      ],
    },
    {
      Index: 1,
    ...
    },
    {
      ...
      Destination: -1,
      Options: [
        { OptionIndex: 3.0, Text: "Yeah, of course!", Destination: 5, AffectionChange: 0 },
        {
          OptionIndex: 5.0,
    ...
    },
    {
      ...
      Destination: -1,
      Options: [
        { OptionIndex: 9.0, Text: "I'll be in touch!", Destination: 9, AffectionChange: 0 },
      ],
    },
    {
      Index: 9,
  ...
  [
    ...
    },
    {
      ...
      Options: [
        ...
        { OptionIndex: 10.0, Text: "Okay.", Destination: 28, AffectionChange: -1 },
      ],
    },
    {
      Index: 27,
    ...
    { Index: 28, CharacterState: "EdnaNeut", Text: "Goodbye.", Background: "Lab", Destination: -1 },
  ],
];
...
const Sylvia = [
  ...
  [
    ...
    { Index: 2, CharacterState: "SylviaFlus", Text: "!!!", Background: "Meeting", Destination: 3 },
    {
      Index: 3,
      CharacterState: "SylviaFlus",
    ...
    },
    {
      ...
      Destination: -1,
      Options: [
        { OptionIndex: 0.0, Text: "Nice!", Destination: 5, AffectionChange: 0 },
        {
          OptionIndex: 1.0,
    ...
    },
    {
      ...
      Destination: -1,
      Options: [
        { OptionIndex: 2.0, Text: "Leave", Destination: -1, AffectionChange: 0 },
        { OptionIndex: 3.0, Text: "Stay", Destination: 9, AffectionChange: 1 },
      ],
    },
    {
      Index: 9,
  ...
  [
    ...
    { Index: 2, CharacterState: "SylviaAgit", Text: "heh.", Background: "Meeting", Destination: 3 },
    {
      Index: 3,
      CharacterState: "SylviaNeut",
      ...
      Destination: -1,
      Options: [
        { OptionIndex: 0.0, Text: "...", Destination: 4, AffectionChange: 0 },
        { OptionIndex: 1.0, Text: "*sobs*", Destination: 4, AffectionChange: 1 },
        {
          OptionIndex: 2.0,
  ...
  [
    {
      ...
      Background: "Corridor",
      Destination: -1,
      Options: [{ OptionIndex: 0, Text: "Alright", AffectionChange: 0, Destination: 1 }],
    },
    {
      Index: 1,
      CharacterState: "JpNeut",
