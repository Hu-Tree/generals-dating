...
const Edna = [
  [
    ...
    },
    {
      ...
      Destination: -1,
      Options: [
        { OptionIndex: 0.0, Text: "Hooray?", Destination: 2, AffectionChange: 0 },
        { OptionIndex: 1.0, Text: "Noted.", Destination: 2, AffectionChange: 1 },
      ],
    },
    {
      Index: 2,
    ...
    },
    {
      ...
      Destination: -1,
      Options: [
        { OptionIndex: 2.0, Text: "Two hundred.", Destination: 6, AffectionChange: -1 },
        { OptionIndex: 3.0, Text: "Around ten?", Destination: 7, AffectionChange: -1 },
        { OptionIndex: 4.0, Text: "As many as it takes!", Destination: 8, AffectionChange: 0 },
      ],
    },
    {
      Index: 6,
    ...
    },
    {
      ...
      Options: [
        ...
        { OptionIndex: 8.0, Text: "Because it's fun!", Destination: 13, AffectionChange: 1 },
        {
          OptionIndex: 9.0,
  ...
  [
    ...
    {
      Index: 2,
      CharacterState: "EndaHappy",
      Text: "Congratulations. Weclome to the team! ",
      Background: "Celebration",
      Destination: -1,
      Options: [
        { OptionIndex: 0.0, Text: "Woah!", Destination: 3, AffectionChange: 0 },
  ...
  [
    ...
    },
    {
      ...
      Options: [
        ...
        { OptionIndex: 2.0, Text: "Noted.", Destination: 3, AffectionChange: 1 },
      ],
    },
    {
      Index: 3,
      CharacterState: "EndaSad",
...
const Sylvia = [
  [
    ...
    },
    {
      ...
      Destination: -1,
      Options: [
        { OptionIndex: 0.0, Text: "Bapple", Destination: 4, AffectionChange: -2 },
        { OptionIndex: 1.0, Text: "Bandroid", Destination: 4, AffectionChange: -2 },
        {
          OptionIndex: 2.0,
    ...
    },
    {
      ...
      Destination: -1,
      Options: [
        { OptionIndex: 7.0, Text: "The money.", Destination: 13, AffectionChange: 0 },
        { OptionIndex: 8.0, Text: "To help other people!", Destination: 13, AffectionChange: 0 },
        {
          OptionIndex: 9.0,
  ...
  [
    ...
    },
    {
      ...
      Options: [
        ...
        { OptionIndex: 11.0, Text: "um er uhhhhhhh SOB", Destination: 8, AffectionChange: -2 },
        {
          OptionIndex: 12.0,
    ...
    },
    {
      ...
      Options: [
        ...
        { OptionIndex: 14.0, Text: "what is a code?", Destination: 10, AffectionChange: -2 },
      ],
    },
    {
      Index: 10,
...
const Jp = [
  [
    ...
    },
    {
      ...
      Destination: -1,
      Options: [
        { OptionIndex: 0.0, Text: "Yes.", Destination: 3, AffectionChange: 1 },
        { OptionIndex: 1.0, Text: "No.", Destination: 4, AffectionChange: -10 },
        { OptionIndex: 2.0, Text: "Business.", Destination: 5, AffectionChange: 2 },
      ],
    },
    {
      Index: 3,
    ...
    { Index: 7, CharacterState: "JpRizz", Text: "First.", Background: "Meeting", Destination: 8 },
    {
      ...
      Destination: -1,
      Options: [
        { OptionIndex: 3.0, Text: "Body count", Destination: 9, AffectionChange: 0 },
        { OptionIndex: 4.0, Text: "Net worth", Destination: 10, AffectionChange: 2 },
        { OptionIndex: 5.0, Text: "Follicle count", Destination: 9, AffectionChange: -1 },
      ],
    },
    {
      Index: 9,
    ...
    },
    {
      ...
      Destination: -1,
      Options: [
        { OptionIndex: 6.0, Text: "More than my own life.", Destination: 13, AffectionChange: 2 },
        { OptionIndex: 7.0, Text: "It's just ok.", Destination: 14, AffectionChange: -1 },
        { OptionIndex: 8.0, Text: "The world runs on it.", Destination: 14, AffectionChange: 0 },
      ],
    },
    {
      Index: 13,
    ...
    },
    {
      ...
      Options: [
        ...
        { OptionIndex: 10.0, Text: "For the money.", Destination: 16, AffectionChange: 2 },
        { OptionIndex: 11.0, Text: "Because it's fun.", Destination: 16, AffectionChange: -1 },
      ],
    },
    {
      Index: 16,
  ...
  [
    ...
    },
    {
      ...
      Options: [
        ...
        { OptionIndex: 2.0, Text: "*blushing* u- uwu???", Destination: 6, AffectionChange: 0 },
      ],
    },
    {
      Index: 4,
  ...
  [
    {
      ...
      Destination: -1,
      Options: [
        { OptionIndex: 0.0, Text: "Yes.", Destination: 1, AffectionChange: 0 },
        { OptionIndex: 1.0, Text: "No.", Destination: 2, AffectionChange: 0 },
      ],
    },
    {
      Index: 1,
    ...
    },
    {
      ...
      Destination: -1,
      Options: [
        { OptionIndex: 5.0, Text: "I propose a dating sim. ", Destination: 9, AffectionChange: 0 },
        {
          OptionIndex: 6.0,
    ...
    },
    {
      ...
      Options: [
        ...
        { OptionIndex: 10.0, Text: "S-sure //uwu//", Destination: 13, AffectionChange: 1 },
      ],
    },
    {
      Index: 11,
    ...
    },
    {
      ...
      Destination: -1,
      Options: [
        { OptionIndex: 11.0, Text: "Deal", Destination: 16, AffectionChange: 1 },
        {
          OptionIndex: 12.0,
        ...
        { OptionIndex: 13.0, Text: "No deal", Destination: 18, AffectionChange: 0 },
      ],
    },
    {
      Index: 17,
